...
const Footer = () => {
  const { email, setEmail, loading, message, messageError, handleSubmit } =
    useEmailSubmit();
    ...
    <footer className="bg-black ">
      <div className="w-[90vw] mx-auto sm:w-[85vw] flex flex-col gap-8 py-16">
        ...
        <div className="flex gap-2 flex-col font-poppins">
          <form
            className="border border-white rounded-full p-1 max-w-[400px] w-full flex"
          ...
          >
            ...
            <button
              disabled={loading}
              className="bg-[#E4FF1A] px-4 py-2 rounded-full text-black"
            >
              Submit
            </button>
          </form>
